...
const Navbar = () => {
  return (
    <nav className="navbar navbar-expand-md navbar-light bg-light shadow-sm mt-1">
        ...
        {/* Brand Logo */}
        <Link to="/" className="navbar-brand fw-bold">Lupin's Crest Luxury Real Estate</Link>
        ...
        <div className="collapse navbar-collapse" id="navbarcontents">
          <ul className="navbar-nav me-auto">
            <li className="nav-item">
              <b><Link to="/" className="nav-link">See Estate</Link></b>
            </li>
            <li className="nav-item">
              <b><Link to="/addhouse" className="nav-link">Add Estate</Link></b>
            </li>
